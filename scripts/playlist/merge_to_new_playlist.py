...
import pandas as pd
import spotipy
from scripts.sync import get_spotify_client, get_user_info, api_call, get_playlist_tracks, _chunked
...
def merge_to_new_playlist(sp: spotipy.Spotify, playlist1_name: str, playlist2_name: str, new_playlist_name: str, delete_newer: bool = True) -> None:
    ...
    if tracks_to_add:
        ...
        chunk_count = 0
        for chunk in _chunked(tracks_list, 50):  # Spotify API limit is 100, using 50 to be safe
            chunk_count += 1
