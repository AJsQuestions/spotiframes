...
Usage:
    python scripts/update_all_playlist_descriptions.py
    python scripts/update_all_playlist_descriptions.py --dry-run  # Preview changes
"""
...
from scripts.sync import (
    get_spotify_client, get_user_info, api_call, get_playlist_tracks,
